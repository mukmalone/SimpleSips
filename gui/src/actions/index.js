//Action creator
import { BUILD_DRINK, RESET_INGREDIENTS, ORDER_DRINK, SCAN_QRCODE, SCANED_QRCODE, GET_NUMDRINKPASSES } from './types';
...
export const get_numDrinkPasses = (numDrinkPasses) => {
    return {
